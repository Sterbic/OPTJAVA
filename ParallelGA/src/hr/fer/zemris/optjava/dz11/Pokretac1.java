...
import hr.fer.zemris.optjava.genetic.ParallelEvaluationGA;
...
/**
 * Progam koji pokrece genetski algoritam s paralelnom evaluacijom jedinki
 ...
 * 7. staza do PNG slike koju ce algoritam generirati kao rjesenja
 * @author Luka Sterbic
 * @version 0.4
 */
public class Pokretac1 {
	...
	public static void main(String[] args) {
		...
		IOptAlgorithm<IntegerArraySolution> parallelEvalGA = new ParallelEvaluationGA<>(
				function,
				populationSize,
